...
def test_transpose_forward():
    #print( ndl.transpose(ndl.Tensor([[[1.95]], [[2.7]], [[3.75]]]), axes=(1, 2)).numpy())
    #print(ndl.transpose(ndl.Tensor([[[[0.95]]], [[[2.55]]], [[[0.45]]]]), axes=(2, 3)).numpy())
    #print( ndl.transpose(       ndl.Tensor(
    #            [
    ...
    #print(  ndl.transpose(ndl.Tensor([[[2.45]], [[3.5]], [[0.9]]]), axes=(0, 1)).numpy()) 
    np.testing.assert_allclose(
